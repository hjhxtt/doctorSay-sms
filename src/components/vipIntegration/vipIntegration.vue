<template>
  <div class="vipIntegration-wrapper">
    ...
    <div class="intr-txt">
      <p>上传参数文本说明：上传的文本需是.txt文本格式的文件，上传的参数必须统一为会员数字ID或者会员手机号</p>
      <p>1.每个参数文本可包含N条参数，参数与参数之间用","（半角）分隔；</p>
      <p>2.每条参数应包含三种数据，会员ID（需要统一数字ID或者会员手机号）|类型|积分数量|积分明细，两种数据之间用"|"（半角）分隔；</p>
      ...
      <div style="margin-left: 40px;">
        ...
        <p style="color: #000000;">15365095178<span style="color: red;">|</span>0<span style="color: red;">|</span>30<span style="color: red;">|</span>8月份推荐10名医生系统奖励300积分<span style="color: red;">,</span></p>
